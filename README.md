...
This is where <b>Meisunry</b> comes in. Choose a folder and look at your images without any unnecessary details. The grid auto-updates when new images/videos are added or removed in the selected folder. Hold Shift to multi-select images and release Shift to view them all at full height in an overlay.
